...
//
// - executes evil game play
// - updates needed values for view labels
...
/**
 * LOAD WORDLIST
 * - load plist into array and compute min and max word length
 **/
...
/**
 * SORT WORDLIST DEPENDING ON LETTER LOCATION
 * - fill dictionary with key value pairs based on letter location(s)
 **/
- (void)sortWordList
{
...
/**
 * SELECT LONGEST WORDLIST IN WORDDICT AND UPDATE WORDLIST
 **/
